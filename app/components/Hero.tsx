...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* ... [Les SVGs restent identiques ici, je les masque pour la clarté] ... */}
      <div className="floating-shape absolute top-[20%] left-[15%] text-[#ea743f] opacity-40 z-0">
        <svg
          className="shape-spin w-16 h-16"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.5"
      ...
      <div className="floating-shape absolute top-[25%] right-[20%] text-zinc-300 z-0">
        <svg
          className="shape-bounce w-12 h-12"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
      ...
      <div className="floating-shape absolute bottom-[30%] left-[20%] text-zinc-300 z-0">
        <svg
          className="shape-bounce w-14 h-14"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
      ...
      <div className="z-10 text-center pointer-events-none">
        {/* 3. Traduction du texte métier */}
        <p className="hero-text text-zinc-500 text-sm md:text-xl uppercase tracking-[0.3em] mb-6 font-medium">
          {lang === "fr"
            ? "STRATÉGIE & CRÉATION DIGITALE"
            : "DIGITAL STRATEGY & CREATION"}
        </p>

        <h1
          ref={titleRef}
          className="text-7xl md:text-[10rem] font-bold uppercase tracking-tighter leading-none flex flex-col md:flex-row gap-4 justify-center"
        >
      ...
      <button
        ...
        aria-label="Défiler vers l'expertise"
      >
        <div className="w-[1px] h-16 bg-zinc-300 overflow-hidden relative">
          <div className="w-full h-full bg-orange-500 animate-slide-down"></div>
        </div>
        <span className="text-xs text-zinc-400 uppercase tracking-widest group-hover:text-orange-500 transition-colors">
          Scroll
        </span>
      </button>
    </section>
